<template>
	<div>
		<div class='head'>
			<div>
				<span style='font-size:14px;font-weight:600;margin-left:20px'>库存消息：</span>
			...
			<div style='margin-left:40px;width:300px;margin-right:20px'>
				<Input style='margin-top:8px;width:300px' v-model='keyword' placeholder='请输入关键词'>
				...
				<div class='main-mark' >
					<li v-for='(item,index) in dataList' :class='{bg:numIndex==index}' @mouseover='mouseover(index)'>
						...
						<div style='margin-left:30px'>
							...
							<span style='display:inline-block;margin-top:10px;'><a target='_blank' :href='item.url' @click='goInfo'>查看详情</a></span>
							</div>
