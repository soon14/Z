                    ...
                    <div class="right-top">
                        ...
                        <div >
                            ...
                            <mu-button small v-if="addText"  @click="addCancel"  style="background:#999999;color:#fff;" ><Icon type="close" style="margin-right:5px;">
                             ...
                             <mu-button small  color="primary" @click="apply" v-if="isapply" >申请</mu-button>
                             <mu-button small  color="primary" @click="assess" v-if="isassess"  >评估</mu-button>
                            <mu-button small  color="primary" @click="pdUser" v-if="pdisshow" >派单</mu-button>

                            <mu-button small @click="updateStoreInfo1" v-if="xiugaibtn1" style="background:#40ca98;color:#fff;border:none" ><i class="el-icon-edit" style=";margin-right:5px;"></i>修改</mu-button>
                            ...
                            <DropdownMenu slot="list">
                             <!--    <span  @click="apply" v-if="isapply"><DropdownItem >申请</DropdownItem></span>
                                <span  @click="assess" v-if="isassess"><DropdownItem >评估</DropdownItem></span>
                ...
                <div class="add-left">
                    ...
                    <div class="left-content">
                        ...
                        <Scroll :on-reach-bottom="handleReachEdge" :height="height" v-else>
                            <li class="con-list" v-for="(item,index) in storeList" :id='setId(item.id)' :key='index' @click="seeStoreInfo(item.id,index)" :class="{bg:numIndex==index}">
                                 ...
                                 <div>
                                    ...
                                    <div class="lanrenLeft" :class="{bgd4:item.status==1,bgd41:item.status==11,bgd42:item.status==22,bgd42:item.status==22,bgd5:item.status==3,bgd6:item.status==9,bgd51:item.status==5}">
                ...
                <div class="add-right">
                    <div class="right-content" v-if="addText">
                        <mu-form ref="form" :model="validateForm" >
                            ...
                            <div  style='display:flex'>
                                <div style='width:50%;'>
                                    ...
                                    <mu-form-item label="手机号"  prop="mobile" :rules="mobileRules">
                                        <mu-text-field type="number" v-model="validateForm.mobile"
                                        prop="mobile"
                            ...
                            <div style='display:flex'>
                                <div style='width:50%;'>
                                    <mu-form-item label="身份证"  prop="sfz" :rules="sfzRules" style='margin-right:20px'>
                                ...
                                <div style='width:50%;padding-left:40px'>
                                    <mu-form-item label="年龄"  prop="age" :rules="ageRules">
                                            <mu-text-field v-model="validateForm.age" type="number" placeholder="请输入年龄"></mu-text-field>
                                    </mu-form-item>
                                </div>
                                <div style='width:50%;padding-left:40px'>
                                    <mu-form-item label="首次服务时间" prop="firstTime">
                                        <mu-date-input  landscape
                                        v-model="validateForm.firstTime"
                                        view-type='list'
                                        type="date"
                                        label-float
                                        container="dialog"

                                        full-width @change='changefirstTime'></mu-date-input>
                                    </mu-form-item>
                            ...
                            <div style='display:flex;'>
                                ...
                                <div style='margin-left:20px;width:15%'>
                                    <mu-form-item label="护理计划表编码">
                                        <mu-text-field v-model="validateForm.planCode"
                                        prop="planCode"
                            ...
                            <div style='display:flex;'>
                                ...
                                <div style='display:flex'>
                                    <mu-form-item label="长护险平台接收"  prop="checkbox1" style='margin-right:20px'>
                                     ...
                                     <mu-form-item label="医护平台派单"  prop="checkbox2" style='margin-right:20px'>
                                        <mu-checkbox v-model="validateForm.checkbox2" :label="validateForm.checkbox22"  @change="changecheckbox2"></mu-checkbox>
                                    </mu-form-item>
                                </div>
                            ...
                            <div style='display:flex;'><!--justify-content: space-between;-->
                                 ...
                                 <mu-form-item label="护理员编号"style='margin-left:10px' v-if="hlcode!=''">
                                        <mu-text-field v-model="hlcode"
                                          >
                                        </mu-text-field>
                                    </mu-form-item>
                            </div>
                            ...
                            <div v-if='num4==1' class='main-btm'>
                                <div style="display:flex">
                                    <div style='border:2px dotted #C0CCDA;border-radius:6px;width:300px'>
                                        ...
                                        <i v-else class="el-icon-plus avatar-uploader-icon"></i>
                                        <span v-if="!validateForm.imageY">医保卡正面照</span>
                                        </el-upload>
                                    </div>
                                   <!--  <div style='border:2px dotted #C0CCDA;border-radius:6px;width:300px;margin-left:20px'>
                                            <el-upload
                                                ...
                                                name='file'
                                                :before-upload="beforeAvatarUpload"
                                                :on-success="handleAvatarSuccessJ2"
                                                >
                                                <img v-if="validateForm.imageY2" :src="validateForm.imageY2" class="avatar">
                                                <i v-else class="el-icon-plus avatar-uploader-icon"></i>
                                                <span v-if="!validateForm.imageY2">医保卡背面照</span>
                                        </el-upload>
                                    </div> -->
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <div style='display:flex'>
                                ...
                                <div style='width:50%;padding-left:40px'>
                                    <mu-form-item label="年龄"  prop="age" >
                                            <mu-text-field disabled v-model="validateForm.age" type="number" placeholder="请输入年龄"></mu-text-field>
                                    </mu-form-item>
                                </div>
                                <div style='width:50%;padding-left:40px'>
                                    <mu-form-item label="首次服务时间" prop="firstTime">
                                ...
                                <div style='padding: 0 20px 0 0;'>
                                 ...
                                 <div style='display:flex'>
                                    <mu-form-item label="长护险平台接收"  prop="checkbox1" style='margin-right:20px'>
                                     ...
                                     <mu-form-item label="医护平台派单"  prop="checkbox2" style='margin-right:20px'>
                                        <mu-checkbox disabled v-model="validateForm.checkbox2" :label="validateForm.checkbox22"  ></mu-checkbox>
                                    </mu-form-item>
                                </div>
                                <div style='padding: 0 10px 20px 0;'>
                                    <div style='padding: 0 10px 10px 0;color: rgba(0,0,0,.54);font-size:14px'>
                           ...
                           <div >
                            ...
                            <div style='display:flex;'><!--justify-content: space-between;-->
                                ...
                                <mu-form-item label="护理员编号"style='margin-left:10px' v-if="hlcode!=''">
                                        <mu-text-field v-model="hlcode" disabled></mu-text-field>
                                </mu-form-item>
             ...
             <ag-grid-vue style='width:100%;' class="ag-theme-balham is-full-widthag" 
                ...
                <div>
                  <!--   <mu-pagination raised circle 
                    ...
                    <Page :total="HLYtotal" size='small' show-total :pageSize='HLYpageSize'  @on-change="HLYchangeSize2"></Page>
                </div>
            <div slot="footer">
              <div class='footer-mark'>
    ...
    export default {
        ...
        data() {
            return {
                ...
                ageRules:[{ validate: (val) => !!val, message:"必须填写年龄"}],
        ...
        methods: {
            ...
            changecheckbox1(s){
                this.validateForm.checkbox1=s

                if(this.validateForm.checkbox1){
                    this.validateForm.checkbox11="已接收"
                }
                if(this.validateForm.checkbox1==false){
                    this.validateForm.checkbox11="未接收"
                }
            },
            changecheckbox2(s){
                this.validateForm.checkbox2=s

                if(this.validateForm.checkbox2){
            ...
            handleAvatarSuccessJ2(res, file){
                this.validateForm.imageY2=res.rows.url
            },
            //双击信息
            ...
            //申请
            apply(){
                this.axios.get('/aunt/apply/'+this.indexId+'?uid='+this.uid).then(res=>{
                    if(res.data.status==200){   
                        this.$notify({
                            title:"",//
                            message:"已申请",
            ...
            //评估
            assess(){
                this.axios.get('/aunt/assess/'+this.indexId+'?uid='+this.uid).then(res=>{
                    if(res.data.status==200){   
                        this.$notify({
                            title:"",//
                            message:"已评估",
            ...
            //派单
            pdUser(){
                this.axios.get('/aunt/sendOrder/'+this.indexId+'?uid='+this.uid).then(res=>{
                    if(res.data.status==200){   
                        this.$notify({
                            title:"",//
                            message:"已派单",
           ...
           enabled(){
            ...
            addStoreInfo() {
                ...
                this.isassess=false
                this.pdisshow=false
                this.addressisEmpty=false//经度纬度
                ...
                this.$refs.form.validate().then((result) => {
                    if(result){
                        this.axios.post('aunt/add?uid='+this.uid,{
                            ...
                            // medicareCardBackPic:this.validateForm.imageY2,//医保卡
                            age:this.validateForm.age,
                            fistCareTime:this.validateForm.firstTime,//首次服务时间
                            caregiversCode:this.hlcode,//护理员编号
                            identityCard:this.validateForm.sfz,//身份证
                            latitude:this.center.lat,//纬度
                            longitude:this.center.lng,//经度
              
                            planningSheet:this.validateForm.planCode,//长护险平台录入计划编码
                            enterPlanFlag:this.validateForm.checkbox1,//接收
                            senfOrderFlag:this.validateForm.checkbox2,//派单
                            enterPlan:this.validateForm.enterPlan,
                        }).then(res=>{
                            if(res.data.status==200){
                                this.addStoreInfo()
                                this.getStoreList(1)
            ...
            getStoreDetail(id) {
                this.axios.get('/aunt/getDetail/'+this.indexId+'?uid='+this.uid).then(res=>{
                    if(res.data.status==200){
                        ...
                        this.validateForm.sfz=rwos.identityCard
                        ...
                        if(rwos.purposeStartTime=="NaN:NaN"){
                            ...
                            console.log(this.validateForm.hlbtime)
                        ...
                        this.hlcode=rwos.caregiversCode
                        ...
                        this.validateForm.imageY=rwos.medicareCardPic//医保卡
                        // this.validateForm.imageY2=rwos.medicareCardBackPic//医保卡背面
                        this.validateForm.tel=rwos.emergencyCall
                        this.validateForm.firstTime=rwos.fistCareTime
                        ...
                        this.validateForm.age=rwos.age
                        this.validateForm.sfz=rwos.identityCard
                        this.validateForm.planCode=rwos.planningSheet//长护险平台录入计划编码
                        ...
                        switch(rwos.status){
                            case 1://申请
                                this.isapply=true//申请
                            
                                this.stop1=false
                                this.enabledisshow=false
                                this.isassess=false//评估
                                this.pdisshow=false//派单
                            break;
                            case 11://评估
                                this.isapply=false//申请
                    
                                this.stop1=false
                                this.enabledisshow=false
                                this.isassess=true//评估
                                this.pdisshow=false//派单
                            break;
                            case 22://派单
                                this.isapply=false//申请
                ...
                this.$refs.Editform.validate().then((result) => {
                    if(result){
                        this.axios.put('/aunt/update?uid='+this.uid,{
                            ...
                            age:this.validateForm.age,
                            fistCareTime:this.validateForm.firstTime,
                            caregiversCode:this.hlcode,
                            identityCard:this.validateForm.sfz,
...
.bgd41{
    border-top:40px solid #3B57E3;
}
.bgd42{
    border-top:40px solid #3B87E3;
}
.bgd51{
