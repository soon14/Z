<template>
						...
						<ul style='display:flex;justify-content: space-between;'>
							<li>
								...
								<p class="main-p" v-if='wxxcxInfo.status!=8'>
									<Button type="primary" style=";margin-top: -6px;height:30px" @click='addBind'>添加体验人员</Button>
	...
	<!--重新授权弹框-->
		...
		<!--添加体验人员-->
		<Modal v-model="widIsshow" width="460px" >
			<p slot="header" style="height:30px;line-height:30px;">
				<span>添加体验人员</span>
			</p>
			...
			<div slot="footer">
				<div >
					<div>
						<Button shape="circle" type="ghost" style="display:inline-block;background:#3b77e3;border:none;color:#fff" @click='sureWid'>确认</Button>
						<Button shape="circle" type="ghost" style="display:inline-block;background:#ccc;border:none;color:#fff" @click='cancelWid'>取消</Button>
					</div>
				</div>
			</div>
		</Modal>
