<template>
	...
	<div class="units-box">
		<div style='display:flex;height:100%;overflow:hidden'>
			...
			<Tabs :animated="false" :value="value0" style="background:#fff;width:100%;height:100%" @on-click="getfhlistbg">
		        <TabPane label="店铺信息" name="0">
		        	<!--店铺信息-->
					<div class="table">
	...
	export default {
		...
		mounted() {
			if(this.$route.params.index){
				this.value0=String(this.$route.params.index)
			}else{
				this.value0='0'
			}
