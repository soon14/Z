		...
		<div style='display:flex;height:100%;overflow:hidden'>
			<Tabs :animated="false"  style="background:#fff;width:100%;height:100%" @on-click="getfhlistbg">
		        <TabPane label="流水账">
					...
					<div class="table">
						<div style='display:flex;'>
		            		...
		            		<DatePicker type="date" :value="createTime" :confirm="true" placeholder="请选择日期" style="width: 200px;margin-top:10px;margin-left:10px" @on-ok="clickOk" @on-change="changeDate"></DatePicker>
						</div>
		        ...
		        <TabPane label="门店营收">
					...
					<div class="table">
						<div style='display:flex;' >
							<div  style='height:50px;font-size:14px;font-weight:900;line-height:50px'>
