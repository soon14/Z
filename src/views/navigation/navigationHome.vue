<template>
	...
	<div class='navigationHome'>
		<div class='head'>
			<div class='left'>
				...
				<div class='zsys'>
					<span>智胜云</span>
					<span style='font-size:12px;font-weight:100;'>zhiShengYun</span>
				</div>
			</div>
			<div class='right'>
				<span>· 初始化导览 ·</span>
	...
	<!--全渠道会员 2-->
	<!-- <div class='navigationHome' v-if="userRoleId==2">
		<navigation-home-crm></navigation-home-crm>
	</div> -->
	</div>
</template>
<script type="text/javascript">
import LoadUrl from '@/components/common/actionLoad'
// import navigationHomeCrm from './navigationHomeCrm'//全渠道会员
export default{
	// components:{
	// 	navigationHomeCrm
	// },
	data(){
		return{
			...
			//2-全渠道会员
			//1-全渠道零售
			userRoleId:this.$store.state.common.user.roleId,
