<template>
               ...
               <Row>
                ...
                <Row>
  	             	 ...
  	             	 <FormItem label="单据日期">
  	               	...
  	               	<FormItem label="预到时间">
  	                    <DatePicker placement='bottom-start' type="date" placeholder="请选择预计到达时间" style="width: 200px" @on-change="Arrival_time" :value="arrival"></DatePicker>
  	               	</FormItem>
  	               	</div>
                </Row>
  ...
  <Modal v-model="warehouseshow" width="750px">
    ...
    <div slot="footer">
      ...
      <!--分页-->
       ...
       <Page :total="cktotal" :pageSize='ckpageSize' size='small' show-total @on-change="getckData" @on-page-size-change="changeckPageSize"></Page>
      </div>
  ...
  <Modal v-model="warehouseshow1" width="750px">
    ...
    <div slot="footer">
      ...
      <!--分页-->
            <div class="page-box" style="text-align:left">
       <Page :total="cktotal1" :pageSize='ckpageSize1' size='small' show-total @on-change="getckData1" @on-page-size-change="changeckPageSize1"></Page>
      </div>
      <div class='title' style='margin:0px'>
        <div style='color:#D15151;font-size:14px'>
          <!-- <Icon type="plus" style='margin-right:5px'></Icon>
    ...
    <Modal v-model="goodsinshow" width="750px">
        ...
        <div slot="footer" style='margin-top:-10px'>
          ...
          <div class="page-box" style="text-align:left">
               <div class="page-box">
                 <Page :total="unittotal" show-total size='small' :pageSize='unitpageSize'  @on-change="unitgetData" @on-page-size-change="unitchangePageSize"></Page>
              </div>
           </div>
          </div>
          <div class='title' style='margin:0px'>
...
//        DetailedId:0,//明细id
    ...
    methods: {
      ...
      geDetails(){
       ...
       //库存模糊搜索
        searchInput(){
          this.axios.get('inventory/listDetail?keyword='+this.keyword+'&uid='+this.uid+'&warehouseId='+this.formid).then((res)=>{
            console.log(res)
            if(res.data.status==200){
              this.goods = res.data.rows
            }
      ...
      getDate(){
       ...
       //下拉加载更多
        ...
        //点击差号
        cancelHome(){
          this.$router.push('/skuinvestigate')
        },
        //点击取消
        gotoDetail(){
           this.detail=true
